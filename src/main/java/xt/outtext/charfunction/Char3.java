...
public class Char3 implements Function<Complex, Double> {
	
	private Function<Complex, Double> s;
	
	public Char3() {
		Function<Complex, Double> h = hseg(-1.0, +1.0);
		Function<Complex, Double> v = vseg(-1.0, +1.0);
		Function<Complex, Double> s1 = new Compose<>(v, t(-1.0,  0.0));
		Function<Complex, Double> s2 = new Compose<>(h, t( 0.0, -1.0));
		Function<Complex, Double> s3 = new Compose<>(h, t( 0.0,  0.0));
		Function<Complex, Double> s4 = new Compose<>(h, t( 0.0, +1.0));
		s = u(s1, s2, s3, s4);
	}
