...
import xt.coloralgo.effect.AbsGradient;
import xt.coloralgo.effect.Periodicity;
import xt.coloralgo.effect.LuminosityPower;
...
public class Main {
	...
	public static void main(String[] args) {
		//int choice = 1;
		for(int choice = 7; choice <= 9; choice ++)
		switch (choice) {
	...
	private static void fractale001() {
		new FractalDrawer(
				new EscapeTimeAlgorithm(new xt.function.ZPower(2), null, 120, 120, true, Color.BLACK, Palette.PALETTE_001,
						new Periodicity(55.0, 0.65),
						new AbsArgGradient()),
	...
	private static void fractale002() {
		new FractalDrawer(
				new EscapeTimeAlgorithm(new xt.function.ZPower(2), null, 5000, 5000, true, Color.WHITE, Palette.PALETTE_002,
						new Periodicity(384.0, 0.333333333)),
	...
	private static void fractale003() {
		new FractalDrawer(
				new EscapeTimeAlgorithm(new xt.function.ZPower(2), null, 5000, 5000, true, Color.WHITE, Palette.PALETTE_003,
						new Periodicity(48.0, 0.0),
						new LuminosityPower(1.5)),
	...
	private static void fractale004() {
		new FractalDrawer(
				new EscapeTimeAlgorithm(new xt.function.ZPower(2), null, 15000, 15000, true, Color.WHITE, Palette.PALETTE_004,
						new Periodicity(226.0, 0.50)),
	...
	private static void fractale005() {
		new FractalDrawer(
				new EscapeTimeAlgorithm(new xt.function.BurningShip(), new Complex(-0.03689236111111108, 0.28564453125), 3500, 3500, true, Color.WHITE, Palette.PALETTE_005,
						new Periodicity(28.73, 5.0 / 6.0)),
	...
	private static void fractale006() {
		new FractalDrawer(
				new EscapeTimeAlgorithm(new xt.function.AntiBurningShip(), new Complex(0.4849, 0.7498), 5000, 5000, true, Color.WHITE, Palette.PALETTE_006,
						new Periodicity(100.0, 0.95)),
	...
	private static void fractale007() {
		new FractalDrawer(
				new EscapeTimeAlgorithm(new xt.function.ZPower(2), null, 2000, 2000, true, Color.WHITE, Palette.PALETTE_007,
						new Periodicity(14.0, 0.0, 16.0, 0.0, 20.0, 0.0),
						new Bubble(14.0, 0.0, 16.0, 0.0, 20.0, 0.0),
						new IterationGradient(0.004, 115.0),
						new LuminosityPower(0.7)),
	...
	private static void fractale008() {
		new FractalDrawer(
				new EscapeTimeAlgorithm(new xt.function.ZPower(2), new Complex(-1.749272, -2.16E-4), 3000, 3000, true, Color.WHITE, Palette.PALETTE_008,
						new Periodicity(50.0, 0.5)), 
	...
	private static void fractale009() {
		new FractalDrawer(
				new EscapeTimeAlgorithm(new xt.function.F4(), new Complex(0.7638888888888888, 0.3125), 3000, 3000, true, Color.BLACK, Palette.PALETTE_009,
						new Periodicity(33.0, 0.0),
						new IterationGradient(0.015, 0),
						new AbsGradient(0.85, 1.0, 1.0),
						new LuminosityPower(0.4)),
