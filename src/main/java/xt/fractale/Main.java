...
public class Main {
	...
	private static void fractaleIntestinale() {
		new FractalDrawer(
				new EscapeTime(
					new ZPower(2), null, 5000, 5000, true, Palette.PALETTE_1, 50.0, 0.4,
	...
	private static void fractaleCourbevoie() {
		FractalColorAlgo escapeTimeAlgorithm = new EscapeTime(
				new ZPower(2), null, 5000, 5000, true, Palette.PALETTE_2, 384.0, 0.333333333,
				new GradientWithIteration(false),
	...
	private static void fractaleHepatique() {
		FractalColorAlgo escapeTimeAlgorithm = new EscapeTime(
				new ZPower(2), null, 5000, 5000, true, Palette.PALETTE_3, 48.0, 0.9,
				new GradientWithIteration(false),
				new GradientWithModulus(false, 0.0, 0.0, 0.0),
				new GradientWithArgument(false, 0.0, 0.0, 0.0),
				new GradientBubble(false, 0.0, 0.0, 0.0));
	...
	private static void fractaleChenille() {
		FractalColorAlgo escapeTimeAlgorithm = new EscapeTime(
				new ZPower(2), null, 15000, 15000, true, Palette.PALETTE_5, 226.0, 0.50,
				new GradientWithIteration(false),
				new GradientWithModulus(false, 0.0, 0.0, 0.0),
				new GradientWithArgument(false, 0.0, 0.0, 0.0),
				new GradientBubble(false, 0.0, 0.0, 0.0)
	...
	public static void main(String[] args) {
		Complex zJulia = new Complex(-0.03689236111111108, 0.28564453125);
		Complex zCenter = new Complex(0.0, 0.58);
		FractalColorAlgo escapeTimeAlgorithm = new EscapeTime(
				new BurningShip(), zJulia, 3500, 3500, true, Palette.PALETTE_6, 28.73, 5.0 / 6.0,
				new GradientWithIteration(false),
				new GradientWithModulus(false, 0.0, 0.0, 0.0),
				new GradientWithArgument(false, 0.0, 0.0, 0.0),
				new GradientBubble(false, 0.0, 0.0, 0.0));
		MathZone mathZone = new MathZone(zCenter, 0.225, 0.150, 0.0);
		FractalDrawer drawer = new FractalDrawer(escapeTimeAlgorithm, mathZone, "C:\\Users\\Luc\\Desktop\\fractaleCerebrale.png", 1440, 960);
		drawer.draw();
	}
}
