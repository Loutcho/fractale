...
public class Main {
	...
	private static void image023() {
			new ImageFile(
					new EscapeTimeAlgorithm(
						new xt.function.F7(), new Complex(0.1, 0.1), 1000, true, 2.4, Color.BLACK, Palette.PALETTE_023,
						new Max(
	...
	private static void image024() {
			new ImageFile(
					new EscapeTimeAlgorithm(
						new xt.function.Bzzz(), new Complex(0.0, 0.0), 1000, true, 1E12, Color.BLACK, Palette.PALETTE_024,
